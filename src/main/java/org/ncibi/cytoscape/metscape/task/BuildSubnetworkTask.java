...
import org.ncibi.cytoscape.metscape.network.SubnetworkBuilder;

import cytoscape.CyNetwork;

public class BuildSubnetworkTask extends AbstractBuildNetworkTask {
	...
	public static boolean buildUsing(Collection<?> nodes,
	...
	private BuildSubnetworkTask(Collection<?> nodes, Collection<?> edges,
	...
	public void run() {
		try {
			...
			SubnetworkBuilder builder = new SubnetworkBuilder(nodes, edges, networkName, network);
			CyNetwork subnetwork = builder.doBuild();
