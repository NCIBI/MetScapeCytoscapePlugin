...
public class ColorPickerComboBoxModel extends DefaultComboBoxModel {
	...
	public ColorPickerComboBoxModel(ControlInterface control){
		this.control = control;
		for (ColorRange crm: ColorRange.values()){
			this.addElement(crm);
		}
		this.setSelectedItem(ColorRange.getDefault());
	}
		
	public void setSelection(ColorRange selection){
		control.colorRangeChanged(selection);
	}
}
